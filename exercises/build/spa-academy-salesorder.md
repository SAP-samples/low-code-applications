# Create Onlineshop Business Process
...
## You will learn
  ...
  - How to create a process that automates purhcase request creation from an online store and approval
...
There are many use cases where you can make a difference using SAP Build Process Automation. During this tutorial, you will see how the purchase request approval from an onlineshop process can be built using forms. These purchase requests have to be reviewed and approved by the manager of the requestor to ensure that the purchase requests are ok. Once approved or rejected, the requester will be notified.
...
4. In the **Create a Business Process** dialog box, do the following:
    ...
    - Enter a **Project Name**: Use: `Olineshop ###` where ### is your group number.

    >Tip: Always use a name that would help users distinguish your workspace from others.

    - Enter a **Short Description**: Onlineshop ### Process.
    - Choose **Create**.
...
2. In the **Create Process** dialog box, provide the following:
    ...
    - Enter a **Name**: Onlineshop Processing.
    - Enter a **Description** for your process: A process to handle an onlineshop.
    - Choose **Create**.
...
2.  Create a datatype **Onlineshop**.

    ![6.1](images/6.1.png)

3. Click on **New Field** to add new fields to the datatype **Onlineshop**.
...
2.  Enter the name as **Onlineshop Trigger**.
...
6. Click on the **Approval Form**  and configure the **Subject** and **Recipients**.
    ...
    - Enter **Please review**.
    - Select **Produc** from the **onlineshopdetails**.
...
6. Click on the **Order Confirmation Form**  and configure the **Subject** and **Recipients**.
    ...
    - Enter **Your Ourchase Request for **.
    - Select **Product** from the onlineshopdetails.
